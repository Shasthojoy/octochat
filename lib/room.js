...
exports.Room.prototype.save = function(onRoomSaved) {
  if (!this.id)
    ...
    octocache.client().set(this.id, true);
...
/**
 * @param {Function} onRoomDeleted The callback invocated when all ends.
 *
...
exports.Room.prototype.delete = function(onRoomDeleted) {
  ...
  if (!this.id)
    ...
    octocache.client().del(this.id, onItemDeleted);
  }
...
exports.find = function(id, onRoomFound) {
  ...
  octocache.client().get(id, onKeyFound);
};
